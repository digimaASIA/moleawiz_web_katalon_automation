...
public class AutomationLogin {
	...
	@Keyword
	def loginWithUserDummy4() {

		// Isi username
		WebUI.setText(findTestObject('Object Repository/Object Login/input_Username_Login'), GlobalVariable.usernameDummy4)

		// Isi password
		WebUI.setText(findTestObject('Object Repository/Object Login/input_Password_Login'), GlobalVariable.passwordDummy4)
	...
	@Keyword
	def loginWithUserEmptyState() {

		// Isi username
		WebUI.setText(findTestObject('Object Repository/Object Login/input_Username_Login'), GlobalVariable.usernameEmptyState)

		// Isi password
		WebUI.setText(findTestObject('Object Repository/Object Login/input_Password_Login'), GlobalVariable.passwordEmptyState)
