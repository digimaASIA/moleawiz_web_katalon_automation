...
WebUI.click(findTestObject('Object My Learning Journey/btn_Filter_Ongoing_My_Learning_Journey'))

WebUI.click(findTestObject('Object My Learning Journey/btn_Filter_New_My_Learning_Journey'))

WebUI.click(findTestObject('Object My Learning Journey/btn_Filter_Completed_My_Learning_Journey'))

WebUI.click(findTestObject('Object My Learning Journey/btn_Filter_All_My_Learning_Journey'))

WebUI.scrollToElement(findTestObject('Object My Learning Journey/btn_Cart_Continue_My_Learning_Journey'), 0)
...
WebUI.scrollToElement(findTestObject('Object My Learning Journey/btn_Cart_Restart_My_Learning_Journey'), 0)
