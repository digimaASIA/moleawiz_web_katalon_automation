...
WebUI.scrollToElement(findTestObject('Object Help Center/list_collapse_help_index_7 - My Learning Journey Descrption 7'), 0)

WebUI.verifyElementVisible(findTestObject('Object Help Center/list_collapse_help_index_7 - My Learning Journey Descrption 7'), FailureHandling.STOP_ON_FAILURE)
