...
WebUI.click(findTestObject('Object Content Library/btn_tab_Content_Library_Content_Library'))
...
WebUI.click(findTestObject('Object Content Library/btn_Add_Course_Collection_Content_Library'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Object Content Library/verify_Succesfully_Add_Course_Collection_Content_Library - Toast Success Add Course Collection'), 
    0)

WebUI.click(findTestObject('Object Content Library/btn_Remove_Course_from_Collection_Content_Library'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Object Content Library/verify_Succesfully_Remove_Course_Collection_Content_Library - Toast Success Remove Course Collection'), 
    0)
...
WebUI.click(findTestObject('Object Content Library/radio_btn_Filter_Course_Collection_Content_Library'))

WebUI.verifyElementPresent(findTestObject('Object Content Library/verify_Succesfully_Add_Course_Collection_Content_Library - Text title cart COURSE'), 
    0)
