...
WebUI.scrollToElement(findTestObject('Object Help Center/list_privacy_policy_help'), 0)

WebUI.click(findTestObject('Object Help Center/list_privacy_policy_help'))
