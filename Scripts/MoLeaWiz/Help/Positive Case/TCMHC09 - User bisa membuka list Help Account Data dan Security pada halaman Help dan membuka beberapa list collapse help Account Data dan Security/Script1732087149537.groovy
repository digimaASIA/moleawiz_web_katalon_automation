...
WebUI.scrollToElement(findTestObject('Object Help Center/list_account_data_security_help'), 0)

WebUI.click(findTestObject('Object Help Center/list_account_data_security_help'))
