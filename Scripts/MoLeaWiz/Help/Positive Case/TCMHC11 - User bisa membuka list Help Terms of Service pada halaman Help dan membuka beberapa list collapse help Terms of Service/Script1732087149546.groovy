...
WebUI.scrollToElement(findTestObject('Object Help Center/list_term_of_service_help'), 0)

WebUI.click(findTestObject('Object Help Center/list_term_of_service_help'))
