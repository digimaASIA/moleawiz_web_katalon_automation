...
WebUI.click(findTestObject('Object User Profile/btn_overview_completed_program_user_profile'))

WebUI.click(findTestObject('Object User Profile/btn_overview_close_completed_program_user_profile'))
